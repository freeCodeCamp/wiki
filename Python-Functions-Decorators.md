...
:rocket: [Run code](https://repl.it/CXGk)
...
:rocket: [Run code](https://repl.it/CXGu)
...
:rocket: [Run code](https://repl.it/CXHC)
...
:rocket: [Run code](https://repl.it/CXHG)
...
:rocket: [Run code](https://repl.it/CXHI)
...
:rocket: [Run code](https://repl.it/CXHL)
...
:rocket: [Run code](https://repl.it/CXHN)
...
:rocket: [Run code](https://repl.it/CXHQ)
...
:rocket: [Run code](https://repl.it/CXH2)
...
```
> Output : `<p>`John Doe`</p>`
:rocket: [Run code](https://repl.it/CXH5)
...
:rocket: [Run code](https://repl.it/CXH6)
...
:rocket: [Run code](https://repl.it/CXHb)
