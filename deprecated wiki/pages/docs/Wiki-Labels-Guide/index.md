...
Listed here are labels for [**FreeCodeCamp Wiki**](https://freecodecamp.com/wiki/docs) &mdash; see [*wiki source*](https://github.com/FreeCodeCamp/wiki) and [*wiki labels*](https://github.com/FreeCodeCamp/wiki/labels).  
...
[![**Label: enhancement**](https://img.shields.io/badge/Label-enhancement-30A9DE.svg?style=flat-square&maxAge=2592000 "Label: enhancement")](https://github.com/FreeCodeCamp/wiki/labels/enhancement) | Enhance codes or algos :pencil: in article(s) | :x: | :white_check_mark:
...
#### Label: `bug`
 This is an *issue only* label.  
 Assign this label to issues related to bugs in [**Wiki**](https://freecodecamp.com/wiki/docs) or in [**FreeCodeCamp**](https://www.freecodecamp.com) or otherwise related.
...
#### Label: `question`
 This is an *issue only* label.  
 This label is used on issues if it is a question about [**Wiki**](https://freecodecamp.com/wiki/docs) or any general question related to [**FreeCodeCamp**](https://www.freecodecamp.com) or otherwise related.
