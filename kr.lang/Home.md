...
- [Wiki에 기여하는 방법](https://github.com/FreeCodeCamp/wiki/blob/master/How-To-Contribute-To-The-Wiki): 당신의 컴퓨터로부터 변경할 수 있도록 로컬 복사본을를 가지고 오는 방법을 보여주는 가이드이며, 메인 저장소에 기여하기 위해 작동합니다.  
