...
- [Waypoint: Comparison with the Greater Than Equal To Operato](http://www.freecodecamp.com/challenges/waypoint-comparison-with-the-greater-than-equal-to-operator)
...
- You will have to make the function return a specific string, depending on the value of the parameters `par` and `strokes` that are passed in to your function.
